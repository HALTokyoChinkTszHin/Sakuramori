...
// マクロ定義
//*****************************************************************************
#define	POS_X_CAM_FIELD		(0.0f)			// カメラの初期位置(X座標)
#define	POS_X_CAM_BATTLE	(-20.0f)		// カメラの初期位置(X座標)

#define	POS_Y_CAM_FIELD		(200.0f)		// カメラの初期位置(Y座標)
#define	POS_Y_CAM_BATTLE	(80.0f)			// カメラの初期位置(Y座標)
...
void InitCamera(void)
{
	...
	g_Camera.pos = { 100.0f, 100.0f, 100.0f };

	if (g_Mode == MODE_GAME)
	{
		g_Camera.pos = { POS_X_CAM_FIELD, POS_Y_CAM_FIELD, POS_Z_CAM };
	}
	else if (g_Mode == MODE_BATTLE)
	{
		g_Camera.pos = { POS_X_CAM_BATTLE, POS_Y_CAM_BATTLE, POS_Z_CAM };
	}
